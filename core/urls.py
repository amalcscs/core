...
urlpatterns = [
    ...
    re_path(r'^trainee_task_details/$', views.trainee_task_details,
    ...
    re_path(r'^MAN_selectproject$', views.MAN_selectproject,
            name='MAN_selectproject'),
...
#     re_path(r'^static/(?P<path>.*)$', serve,{'document_root': settings.STATIC_ROOT}),
    ...
    re_path(r'^man_internship_update/(?P<id>\d+)/$', views.man_internship_update, name="man_internship_update"),
